...
.PARAMETER Clean
Removes the image silverscreen and kills all containers based on that image.
...
Build a Docker image named silverscreen
#>
...
$imageName="silverscreen"
$projectName="silverscreen"
$serviceName="silverscreen"
